...
# PRODUCTS_PATH = '/home/tomas/receptu_meistras/data/barbora.csv'
PRODUCTS_PATH = 'barbora.csv'
...
#     response = requests.get(ELASTIC_HOST, {
...
def match_products_elastic(ingredients, limit=5):
    all_matches = []
...
def match():
    ...
    matches = match_products_elastic(ingredients)
